...
class ReviewGraph:
    ...
    def new_reviewer(self, name: str, anomalous_score: float | None = None) -> Reviewer:
    ...
    def add_review(self, reviewer: Reviewer, product: Product, rating: float, _time: int | None = None) -> float:
